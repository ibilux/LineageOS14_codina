...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/system/libNew/libsec-ril.so:system/lib/libsec-ril.so
else
PRODUCT_COPY_FILES += \
...
ifeq ($(DEVICE_ENABLE_PLLDDR),true)
# pllddr scripts for Chrono Kernel 3.
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/system/pllddr/pllddr_oc.sh:install/bin/pllddr_oc.sh

#PRODUCT_COPY_FILES += \
#    $(LOCAL_PATH)/system/pllddr/00userinit:install/bin/00userinit \
#    $(LOCAL_PATH)/system/pllddr/mkshrc:install/bin/mkshrc \
#    $(LOCAL_PATH)/system/pllddr/sh:install/bin/sh
endif
...
# bootanimation
PRODUCT_COPY_FILES += \
    vendor/samsung/u8500-common/codina/bootanimation/480.zip:system/media/bootanimation.zip
